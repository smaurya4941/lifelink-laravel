<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                <x-input-label for="traditional_state" :value="__('State')" />
                <x-text-input id="traditional_state" name="traditional_state" type="text" class="mt-1 block w-full" :value="old('traditional_state', $user->traditional_state)" />
                <x-input-error class="mt-2" :messages="$errors->get('traditional_state')" />
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <x-text-input id="latitude" name="latitude" type="text" class="mt-1 block w-full" :value="old('latitude', $user->latitude)" />
                <x-input-error class="mt-2" :messages="$errors->get('latitude')" />
            </div>
            <div>
                <x-input-label for="longitude" :value="__('Longitude')" />
                <x-text-input id="longitude" name="longitude" type="text" class="mt-1 block w-full" :value="old('longitude', $user->longitude)" />
